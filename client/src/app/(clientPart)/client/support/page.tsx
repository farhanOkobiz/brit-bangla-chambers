...
// Define the HelpRequest type (adjust fields as needed)
type HelpRequest = {
  _id: string;
  subject: string;
  message: string;
    ...
    <div className="max-w-8xl mx-auto py-10 px-6">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        >
          ...
          <button
            ...
            className={`mt-6 w-full py-3.5 rounded-lg font-semibold transition-all ${
              isLoading
                ...
                : "bg-gray-600 cursor-pointer text-white hover:bg-gray-700 hover:shadow-md"
            }`}
          >
            {isLoading ? (
          ...
          {success && (
            <div className="mt-4 p-3 bg-green-50 text-green-700 rounded-lg text-center font-medium">
              {success}
            </div>
          )}
          {error && (
        ...
        {isFetching ? (
          ...
          requests.map((req: HelpRequest) => (
            ...
            >
              ...
              <div className="text-gray-600 mb-3 line-clamp-2">{req.message}</div>
