...
const ServicesDisplay = () => {
 ...
 <div className="fixed inset-0 bg-black/40 backdrop-blur-3xl flex items-center justify-center z-50 p-6 md:p-10">
   <div className="bg-white rounded-lg shadow-lg w-full md:h-10/12 max-w-5xl p-8 py-2 relative overflow-y-auto">
     <button
     ...
     <div className="py-6">
       ...
       <div className="block md:hidden">
         <div className="relative w-full h-56 overflow-hidden rounded mb-4">
           <Image
       ...
       {/* Desktop Layout - Wrapped content around image */}
       <div className="hidden md:block">
         ...
         {/* Content with wrapped layout */}
         <div className="relative">
           {/* Floating image */}
           <div className="float-left mr-6 mb-4 w-1/2">
             <div className="relative w-full h-76 lg:h-[370px] overflow-hidden rounded">
               <Image
                 src={`${image_url}${selectedService?.serviceImage}`}
                 alt={selectedService?.title}
                 fill
           ...
           {/* Description that wraps around the image */}
