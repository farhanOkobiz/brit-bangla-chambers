...
const menuItems = [
  { label: "Dashboard", path: "/advocate/dashboard", icon: <FaGavel /> },
  {
    label: "Message",
    path: "/advocate/dashboard/message",
    icon: <FaCommentDots />,
  },
  { label: "My Cases", path: "/advocate/cases", icon: <FaGavel /> },
  {
    label: "Appointments",
    path: "/advocate/appointments",
    icon: <FaCalendarAlt />,
  },
  { label: "Clients", path: "/advocate/clients", icon: <FaUsers /> },
  {
    label: "Blogs",
    isDropdown: true,
    icon: <FaBlog />,
