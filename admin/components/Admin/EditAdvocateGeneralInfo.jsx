      ...
      <div className="bg-white rounded-2xl shadow-lg p-8">
        <div className="relative">
          ...
          <button
            ...
            onClick={() =>
              setForm((prev) => ({ ...prev, editingFullName: true }))
            }
          >
            ✏️
          </button>
        ...
        <div className="flex flex-col items-center mb-6">
          <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-blue-200 shadow flex items-center justify-center bg-slate-50">
            {form.profile_photo_url ? (
              <img
                src={`${IMAGE_URL}${form.profile_photo_url}`}
                alt="Profile"
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-6">
            ...
            <div className="grid grid-cols-2 gap-2">
              {Object.entries(form.available_hours).map(([day, value]) => (
                <div key={day} className="flex items-center gap-2 mb-2">
                  ...
                  <button
                    type="button"
                    className="text-red-600 text-xs bg-red-100 p-1 rounded-md"
                    onClick={() => {
                      setForm((prev) => {
            ...
            <div className="mt-2">
              <select
                id="add-day"
                className="border border-slate-200 rounded px-2 py-1 mr-2"
                defaultValue=""
                onChange={(e) => {
          ...
          <div className="mt-6">
            ...
            <input
              ...
              placeholder="Phone"
              className="w-full border border-slate-200 rounded-lg px-3 py-2 mb-2 bg-slate-50"
            />
            <input
              name="facebook"
          ...
          <div className="mt-6 grid grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full border border-slate-200 rounded-lg px-3 py-2 bg-slate-50 mb-2"
              />
            </div>
          ...
          <div className="mt-8">
            <button
              type="submit"
              className={`px-8 py-3 rounded-xl cursor-pointer shadow font-bold w-full transition ${
                loading
